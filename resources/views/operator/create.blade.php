...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
        	<a href="{{url('operator/user')}}"><button type="button" class="btn btn-success">Back to Staff</button></a><hr>
            <div class="panel panel-default">
                <div class="panel-heading">Register</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('operator/user/store') }}">
                        {{ csrf_field() }}
